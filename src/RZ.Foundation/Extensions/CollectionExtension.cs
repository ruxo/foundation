...
public static class CollectionExtension{
    ...
    /// <summary>
    /// Find maximum value if possible
    /// </summary>
    /// <param name="seq"></param>
    /// <typeparam name="T"></typeparam>
    /// <returns></returns>
    [Pure]
    public static Option<T> TryMax<T>(this Seq<T> seq)
    ...
    [Pure]
    public static Option<T> TryMaxBy<T>(this Seq<T> seq, IComparer<T> comparer)
        => seq.IsEmpty ? None : Optional(seq.Max(comparer));
    ...
    /// <returns></returns>
    [Pure]
    public static Option<T> TryMin<T>(this Seq<T> seq)
    ...
    [Pure]
    public static Option<T> TryMinBy<T>(this Seq<T> seq, IComparer<T> comparer)
        => seq.IsEmpty ? None : Optional(seq.Min(comparer));
