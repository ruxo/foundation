...
namespace RZ.Foundation.Extensions
{
    public static class NullableExtension
    {
        ...
        public static T? Where<T>(this T? v, Predicate<T> predicate) where T : class => v != null && predicate(v) ? v : null;
        public static T? Where<T>(this T? v, Predicate<T> predicate) where T : struct => v.HasValue && predicate(v.Value) ? v : null;
    }
